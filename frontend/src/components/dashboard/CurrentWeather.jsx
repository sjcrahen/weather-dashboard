...
const CurrentWeather = React.memo(function CurrentWeather({ ds }) {
    ...
    return (
        <div className="h-48 flex flex-row w-full gap-x-4">
            <div className="dashboard wind-observation card p-sm flex flex-col grow">
            ...
            <div className="dashboard wind-observation card flex flex-col grow">
