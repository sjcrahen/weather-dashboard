...
function Forecast({ ds }) {
    ...
    return (
        <div className="dashboard card flex flex-col col-span-12 md:col-span-6 lg:col-span-7 xl:col-span-4 2xl:col-span-4 sm:row-span-10">
            ...
            <div className="grid grid-cols-3 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-2 2xl:grid-cols-3 gap-3 auto-rows-[96px]">
                <div className="card order-1 p-sm col-span-3 sm:col-span-1 row-span-1 flex flex-col">
                ...
                <div className="card p-sm order-2 col-span-3 sm:col-span-1 row-span-1 flex flex-col justify-stretch">
                    <div className="flex flex-row items-center justify-center font-medium">
                ...
                <div className="card p-sm order-4 col-span-3 sm:col-span-1 md:hidden lg:col-span-1 xl:hidden 2xl:col-span-1 row-span-1 flex flex-col">
                    <div className="flex flex-row items-center justify-center font-medium">
                ...
                <div className="card p-sm order-5 col-span-3 md:col-span-2 lg:col-span-3 xl:col-span-2 2xl:col-span-3 row-span-1 flex flex-row justify-between items-center">
                    <div className="pl-4">
                ...
                <div className="card p-sm order-6 col-span-3 md:col-span-2 lg:col-span-3 xl:col-span-2 2xl:col-span-3 row-span-1 flex flex-row justify-between items-center">
                    <div className="pl-4">
